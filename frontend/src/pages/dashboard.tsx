...
const Dashboard = () => {
  ...
  const [hobbies, setHobbies] = React.useState('Loading...');
  const [events, setEvents] = React.useState('Loading...');
  const [friends, setFriends] = React.useState('Loading...');
    ...
    <>
      ...
      <SectionMain>
        ...
        >
          ...
          {hasPermission(currentUser, 'READ_HOBBIES') && (
            <Link href={'/hobbies/hobbies-list'}>
              <div
                className={`${
                  corners !== 'rounded-full' ? corners : 'rounded-3xl'
                } dark:bg-dark-900 ${cardsStyle} dark:border-dark-700 p-6`}
          ...
          {hasPermission(currentUser, 'READ_FRIENDS') && (
            <Link href={'/friends/friends-list'}>
              <div
                className={`${
                  corners !== 'rounded-full' ? corners : 'rounded-3xl'
                } dark:bg-dark-900 ${cardsStyle} dark:border-dark-700 p-6`}
