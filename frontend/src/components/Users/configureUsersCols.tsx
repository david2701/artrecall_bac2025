...
export const loadColumns = async (
  ...
  return [
...

    {
      ...
      type: 'singleSelect',
      valueFormatter: ({ value }) =>
        dataFormatter.hobbiesManyListFormatter(value).join(', '),
      renderEditCell: (params) => (
        <DataGridMultiSelect {...params} entityName={'hobbies'} />
      ),
    },
...

    {
      ...
      type: 'singleSelect',
      valueFormatter: ({ value }) =>
        dataFormatter.friendsManyListFormatter(value).join(', '),
      renderEditCell: (params) => (
        <DataGridMultiSelect {...params} entityName={'friends'} />
      ),
    },
