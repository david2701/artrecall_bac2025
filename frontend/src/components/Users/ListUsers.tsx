            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>Last Gps</p>
                    <p className={'line-clamp-2'}>{item.last_gps}</p>
                  </div>
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>
                      {dataFormatter
                        .hobbiesManyListFormatter(item.hobbies)
                        .join(', ')}
                    </p>
                  </div>
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>
                      {dataFormatter.booleanFormatter(item.premium)}
                    </p>
                  </div>
