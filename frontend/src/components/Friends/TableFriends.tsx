...
import { loadColumns } from './configureFriendsCols';
...
const TableSampleFriends = ({
  ...
  useEffect(() => {
    if (friendsNotify.showNotification) {
      notify(friendsNotify.typeNotification, friendsNotify.textNotification);
    }
  }, [friendsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/friends/friends-view/?id=${id}`);
  };
...
export default TableSampleFriends;
